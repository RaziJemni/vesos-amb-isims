...
const FORM_FIELD_IDS = {
  ...
  facebookLink: process.env.NEXT_PUBLIC_GOOGLE_FORM_FACEBOOK_FIELD || "entry.111111111",
  region: process.env.NEXT_PUBLIC_GOOGLE_FORM_REGION_FIELD || "entry.222222222",
  university: process.env.NEXT_PUBLIC_GOOGLE_FORM_UNIVERSITY_FIELD || "entry.345678901",
  studyLevel: process.env.NEXT_PUBLIC_GOOGLE_FORM_STUDY_LEVEL_FIELD || "entry.333333333",
  specialty: process.env.NEXT_PUBLIC_GOOGLE_FORM_SPECIALTY_FIELD || "entry.444444444",
  clubExperience: process.env.NEXT_PUBLIC_GOOGLE_FORM_CLUB_EXP_FIELD || "entry.555555555",
  desiredPosition: process.env.NEXT_PUBLIC_GOOGLE_FORM_POSITION_FIELD || "entry.666666666",
  department: process.env.NEXT_PUBLIC_GOOGLE_FORM_DEPARTMENT_FIELD || "entry.777777777",
  sosVillageKnowledge: process.env.NEXT_PUBLIC_GOOGLE_FORM_SOS_KNOWLEDGE_FIELD || "entry.888888888",
  inPersonMeeting: process.env.NEXT_PUBLIC_GOOGLE_FORM_IN_PERSON_FIELD || "entry.999999999",
  additionalInfo: process.env.NEXT_PUBLIC_GOOGLE_FORM_ADDITIONAL_INFO_FIELD || "entry.121212121",
}
...
export function JoinForm({ t, language }: JoinFormProps) {
  ...
  const validateForm = (): boolean => {
    ...
    if (formData.desiredPosition === "member" && !formData.department) newErrors.department = true
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      googleFormData.append(FORM_FIELD_IDS.facebookLink, formData.facebookLink)
      ...
      googleFormData.append(FORM_FIELD_IDS.studyLevel, formData.studyLevel)
      googleFormData.append(FORM_FIELD_IDS.specialty, formData.specialty)
      googleFormData.append(FORM_FIELD_IDS.clubExperience, formData.clubExperience)
      googleFormData.append(FORM_FIELD_IDS.desiredPosition, formData.desiredPosition)
      googleFormData.append(FORM_FIELD_IDS.department, formData.department)
      googleFormData.append(FORM_FIELD_IDS.sosVillageKnowledge, formData.sosVillageKnowledge)
      googleFormData.append(FORM_FIELD_IDS.inPersonMeeting, formData.inPersonMeeting)
      googleFormData.append(FORM_FIELD_IDS.additionalInfo, formData.additionalInfo)
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  />
                  {errors.fullname && <p className="text-xs text-red-500">This field is required</p>}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  />
                  {errors.phone && <p className="text-xs text-red-500">This field is required</p>}
                </div>

                <div className="space-y-2">
                  <Label htmlFor="facebookLink" className="text-primary-dark">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  />
                  {errors.region && <p className="text-xs text-red-500">This field is required</p>}
                </div>

                <div className="space-y-2">
                  <Label className={`text-primary-dark ${errors.university ? "text-red-500" : ""}`}>
                  ...
                  <div className="flex gap-4 mt-3">
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-primary-dark">{t.join.form.universityISIMS}</span>
                    </label>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input
                        type="radio"
                        ...
                        className="w-4 h-4"
                      />
                      <span className="text-primary-dark">{t.join.form.universityOther}</span>
                    </label>
                  </div>
                  {errors.university && <p className="text-xs text-red-500">This field is required</p>}
                </div>
              </div>

              {/* Row 4: Study Level and Specialty */}
              <div className="space-y-2">
                <Label className={`text-primary-dark ${errors.studyLevel ? "text-red-500" : ""}`}>
                    ...
                    <label key={option.value} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (errors.studyLevel) setErrors({ ...errors, studyLevel: false })
                        }}
                        className="w-4 h-4"
                      />
                      <span className="text-primary-dark">{option.label}</span>
                    </label>
                  ))}
                </div>
                {errors.studyLevel && <p className="text-xs text-red-500">This field is required</p>}
              </div>

              <div className="space-y-2">
                <Label htmlFor="specialty" className="text-primary-dark">
                ...
                <Input
                  ...
                  onChange={(e) => {
                    ...
                    if (errors.specialty) setErrors({ ...errors, specialty: false })
                  }}
                  className={`h-11 bg-white text-primary-dark ${errors.specialty ? "border-red-500" : ""}`}
                />
                {errors.specialty && <p className="text-xs text-red-500">This field is required</p>}
              </div>

              {/* Row 5: Club Experience */}
              <div className="space-y-2">
                <Label className={`text-primary-dark ${errors.clubExperience ? "text-red-500" : ""}`}>
                  ...
                  {[
                    ...
                    <label key={option.value} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => {
                          setFormData({ ...formData, clubExperience: e.target.value })
                          if (errors.clubExperience) setErrors({ ...errors, clubExperience: false })
                        }}
                        className="w-4 h-4"
                      />
                      <span className="text-primary-dark">{option.label}</span>
                ...
                {errors.clubExperience && <p className="text-xs text-red-500">This field is required</p>}
              </div>

              {/* Row 6: Desired Position */}
              <div className="space-y-2">
                <Label className={`text-primary-dark ${errors.desiredPosition ? "text-red-500" : ""}`}>
                  {t.join.form.desiredPosition}
                </Label>
                <div className="flex flex-col gap-3 mt-3">
                  {[
                    { value: "treasurer", label: t.join.form.positionTreasurer },
                    { value: "event-manager", label: t.join.form.positionEventManager },
                    { value: "digital-assistant", label: t.join.form.positionDigitalCommunicationAssistant },
                    ...
                    <label key={option.value} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (errors.desiredPosition) setErrors({ ...errors, desiredPosition: false })
                        }}
                        className="w-4 h-4"
                      />
                      <span className="text-primary-dark text-sm">{option.label}</span>
                    </label>
                  ))}
                </div>
                {errors.desiredPosition && <p className="text-xs text-red-500">This field is required</p>}
              </div>

              {/* Row 7: Department (shown if member selected) */}
              {formData.desiredPosition === "member" && (
                <div className="space-y-2">
                  <Label className={`text-primary-dark ${errors.department ? "text-red-500" : ""}`}>
                  ...
                  {errors.department && <p className="text-xs text-red-500">This field is required</p>}
                </div>
              )}

              {/* Row 8: SOS Village Knowledge */}
              <div className="space-y-2">
                <Label className={`text-primary-dark ${errors.sosVillageKnowledge ? "text-red-500" : ""}`}>
                  ...
                  {[
                    ...
                    <label key={option.value} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => {
                          setFormData({ ...formData, sosVillageKnowledge: e.target.value })
                          if (errors.sosVillageKnowledge) setErrors({ ...errors, sosVillageKnowledge: false })
                        }}
                        className="w-4 h-4"
                      />
                      <span className="text-primary-dark text-sm">{option.label}</span>
                ...
                {errors.sosVillageKnowledge && <p className="text-xs text-red-500">This field is required</p>}
              </div>

              {/* Row 9: In-Person Meeting */}
              <div className="space-y-2">
                <Label className={`text-primary-dark ${errors.inPersonMeeting ? "text-red-500" : ""}`}>
                  ...
                  {[
                    ...
                    <label key={option.value} className="flex items-center gap-2 cursor-pointer">
                      <input
                        ...
                        onChange={(e) => {
                          setFormData({ ...formData, inPersonMeeting: e.target.value })
                          if (errors.inPersonMeeting) setErrors({ ...errors, inPersonMeeting: false })
                        }}
                        className="w-4 h-4"
                      />
                      <span className="text-primary-dark">{option.label}</span>
                ...
                {errors.inPersonMeeting && <p className="text-xs text-red-500">This field is required</p>}
              </div>

              {/* Row 10: Additional Info */}
              <div className="space-y-2">
                <Label htmlFor="additionalInfo" className="text-primary-dark">
              ...
              {status === "success" && (
                <p className="text-center text-sm text-green-600 font-medium">{t.join.form.success}</p>
              )}

              {status === "error" && (
                <p className="text-center text-sm text-red-600 font-medium">Please fill in all required fields to complete your registration.</p>
              )}
            </form>
          </div>
        </div>
