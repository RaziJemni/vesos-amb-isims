...
export function Navigation({ t, currentLanguage, onLanguageToggle }: NavigationProps) {
        ...
        <div className="container px-4">
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Button onClick={() => handleNavClick("#join")} className="bg-primary hover:bg-primary/90 text-white">
                {t.nav.join}
              </Button>
              <LanguageToggle currentLanguage={currentLanguage} onToggle={onLanguageToggle} />
            </div>
